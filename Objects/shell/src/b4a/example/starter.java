...
public static b4a.example.shoes _shoes = null;
  public Object[] GetGlobals() {
		return new Object[] {"Clothes",Debug.moduleToString(b4a.example.clothes.class),"Main",Debug.moduleToString(b4a.example.main.class),"Service",starter.mostCurrent._service,"Shoes",Debug.moduleToString(b4a.example.shoes.class)};
}
}